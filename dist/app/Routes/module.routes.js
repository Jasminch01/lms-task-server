...
router.post("/modules/create", (0, auth_1.auth)("admin"), module_controller_1.moduleControllers.createModule);
...
router.put("/modules/:id", (0, auth_1.auth)("admin"), module_controller_1.moduleControllers.moduleUpdate);
router.delete("/modules/:id", (0, auth_1.auth)("admin"), module_controller_1.moduleControllers.moduledelete);
